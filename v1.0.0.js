...
//select all of the "sliding doors" on the page
var theDOM = {
  slides: document.querySelectorAll('.slide'),
  message: document.querySelector('.messageCenter')
}
...
for (i=0;i<slidesArr.length;i++) {
  ...
  var clickTwo = true;
  slidesArr[i].addEventListener('click' ,theyClicked);
}
...
//Have the user click the door they want to use

//Add a highlight around the door they selected

//Show a goat

//Allow the user to select another door, move the highlight
